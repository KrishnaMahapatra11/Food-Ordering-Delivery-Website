                ...
                <div className="card-body d-flex flex-column">
                    ...
                    {!showButtons ? (
                        <button
                            type="button"
                            id="cart_btn"
                            className="btn-primar d-inline ml-4"
                        ...
                        <div className="stockCounter d-inline">
                            <span className="btn minus" style={{ backgroundColor: "red", color: "white" }} onClick={decreaseQty}>
                                -
                            </span>
                            <input
                                type="number"
                                ...
                                readOnly
                            />
                            <span className="btn plus" style={{ backgroundColor: "dodgerblue", color: "white" }} onClick={increaseQty}>
                                +
                            </span>
                        </div>
                    )}
